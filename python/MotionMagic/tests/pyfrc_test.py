...
def test_motion_magic(control: 'RobotTestController', robot: MyRobot):
    with control.run_robot():
        ...
        target_control = controls.MotionMagicVoltage(SECOND_SET)
        ...
        pos.wait_for_update(1)
        assert_almost_equal(pos.value, SECOND_SET, 0.05)
